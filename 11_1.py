...
# ===== Run 11.1 ===== #
stWgt = pd.read_csv("data/test11_1_weights.csv")["W"].values
returns = pd.read_csv("data/test11_1_returns.csv").values

output = expost_11_1(stWgt, returns)
output.to_csv("data/testout11_1.csv", index=False)

print("✅ Saved testout11_1.csv")
